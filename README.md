...
| LambdaClass geth get() | `110.7 ns` | `139.6 ns` | `247.6 ns` | `484.5 ns` |
| insert() | `327.44 ns` | `407.50 ns` | `778.76 ns` | `1.6858 µs` |
| LambdaClass geth insert() | `536.3 ns` | `820.3 ns` | `1.624 µs` | `2.649 µs` |

| Bench | 100 | 500 | 1k | 2k | 5k | 10k |
|----------|------|-----------|-------------|----|---|---|
| root Keccak256 | `113.63 µs` | `557.49 µs` | `1.1775 ms` | `2.3716 ms` | `5.8113 ms` | `11.737 ms` |
| LambdaClass geth root Keccak256 | `102.358 µs` | `504.081 µs` | `989.531 µs` | `1.936 ms` | `5.59 ms` | `11.458 ms` |
